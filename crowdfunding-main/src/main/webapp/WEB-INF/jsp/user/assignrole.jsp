                ...
                <div class="panel-body">
                    <form role="form" class="form-inline">
                        <div class="form-group">
                            ...
                            <select id="leftRoleList" class="form-control" multiple size="10" style="width:230px;overflow-y:auto;">
                        ...
                        <div class="form-group" style="margin-left:40px;">
                            ...
                            <select id="rightRoleList" class="form-control" multiple size="10" style="width:230px;overflow-y:auto;">
...
<script type="text/javascript">
    ...
    $("#leftToRightBtn").click(function () {
        ...
        if(ids==""){
            layer.msg("请点击角色进行分配",{time:1000, icon:5, shift:6},function () {
            })
        }else{
            var jsonObj = {
                userid: "${param.id}",
    ...
    $("#rightToLeftBtn").click(function () {
        ...
        $.ajax({
            ...
            success:function () {
                layer.close(loadingIndex);
                layer.msg("取消分配成功",{time:1000, icon:1, shift:6},function () {
                })
            }
        })
        }
