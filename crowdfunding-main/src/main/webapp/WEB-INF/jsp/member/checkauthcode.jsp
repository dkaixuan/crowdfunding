...
<div class="container theme-showcase" role="main">
    ...
    <form role="form" style="margin-top:20px;">
        <div class="form-group">
            ...
            <input type="text" class="form-control"  id="authcode" id="exampleInputEmail1" placeholder="请输入你邮箱中接收到的验证码">
        </div>
    ...
    $("#finishBtn").click(function () {
        $.ajax({
            ...
            success : function(result) {
                ...
                if (result.msg=="处理成功") {
                    layer.msg("实名认证申请中", {time:1000, icon:6}, function(){
                        window.location.href = "${APP_PATH}/member.htm";
                    });
                } else {
                    layer.msg("验证失败，请重新输入", {time:1000, icon:5, shift:6});
                }
            }
        })
    })
